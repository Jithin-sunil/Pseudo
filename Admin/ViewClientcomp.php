    ...
    <div class="container">
        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php 
                        $selqry="SELECT * FROM tbl_complaint u INNER JOIN tbl_request j ON u.request_id=j.request_id INNER JOIN tbl_work p ON j.work_id=p.work_id INNER JOIN tbl_client c ON u.client_id=c.client_id";
